		<div class="sidebar-wrapper" data-simplebar="true">
			...
			<ul class="metismenu" id="menu">
				<li>
					...
					<ul>
						<li> <a href="{{ route('category.index') }}"><i class='bx bx-radio-circle'></i>Show All Categories</a>
						</li>
				...
				<li>
					...
					<ul>
						<li> <a href="{{ route('product.index') }}"><i class='bx bx-radio-circle'></i>Show All Products</a>
						</li>
						<li> <a href="{{ route('product.create') }}"><i class='bx bx-radio-circle'></i>Create Product</a>
						</li>
					</ul>
				</li>
				<li>
